...
#define PATTROWS 1048576
#define LOCALHISTORYLENGTH 16
#define MAXPLEN 8
...
private:
    ...
    class patternpredictor {
        ...
        unsigned char ready[PATTROWS][2];
...
#define LOGB 19				// log of number of entries in bimodal predictor
#define HYSTSHIFT 0		// sharing an hysteris bit between 4 bimodal predictor entries
#define LOGG 19		// initial definition was with 2K entries per tagged tables
...
#define NSTAT 5
#define CSTAT 6
#define LOGStatCor 19	// the Statistical Corrector predictor features 5 * 1K entries
...
#define LOGL 19			//64 entries loop predictor 4-way skewed associative
