...
#define LOGG 10		// initial definition was with 2K entries per tagged tables
...
#define NSTAT 5
#define CSTAT 5
#define LOGStatCor 10	// the Statistical Corrector predictor features 5 * 1K entries
...
#define LOOPTAG 8		//tag width in the loop predictor
...
#define PRINTCHAR
        ...
        //cout << "\nTable 1. No of entries = " << (1 << (logg[1])) << "\t Bits per entry = " << (CWIDTH + 1 + TB[1]);
        
        STORAGESIZE += (1 << (logg[STEP1])) * (CWIDTH + 1 + TB[STEP1]);
        //cout << "\nTable 2. No of entries = " << (1 << (logg[STEP1])) << "\t Bits per entry = " << (CWIDTH + 1 + TB[STEP1]);
        
        STORAGESIZE += (1 << (logg[STEP2])) * (CWIDTH + 1 + TB[STEP2]);
        //cout << "\nTable 3. No of entries = " << (1 << (logg[STEP2])) << "\t Bits per entry = " << (CWIDTH + 1 + TB[STEP2]);
        
        STORAGESIZE += (1 << (logg[STEP3])) * (CWIDTH + 1 + TB[STEP3]);
        //cout << "\nTable 4. No of entries = " << (1 << (logg[STEP3])) << "\t Bits per entry = " << (CWIDTH + 1 + TB[STEP3]);
        ...
        //cout << "\nTable Bimodal. Size in bits = " << (1 << LOGB) << " + " << (1 << (LOGB - HYSTSHIFT));
